...
<body>
<c:if test="${existFreelancer != null and existFreelancer ==  'y'}">
	<script>
		alert("이미 존재하는 이메일입니다.");
	</script>
</c:if>
<h1 id="page_title">프리랜서 등록</h1>
<div id="wrap"> <!-- wrap S -->
	<form action="" method="post" name="fl_input_frm">
		<table class="fl_table">
			<tr>
				<th colspan="8" class="fir_th">프리랜서 등록</th>
			</tr>
			<tr>
				<th>이름</th>
				<td><input type="text" name="fl_name" /></td>
				<th>성별</th>
				<td>
				...
				<th>이메일</th>
				<td><input type="email" name="fl_email" /></td>
				<th>핸드폰</th>
				<td>
					<input type="text" name="fl_phone" />
			...
			<tr>
				...
				<td colspan="7">
					...
					<input type="checkbox" name="d_fixed" value="y" id="d_ixed" /><label for="fixed">단가고정</label>
			...
			<tr>
				<td colspan="8">
					<input type="button" value="저장" onclick="submitFrm()" />
				</td>
			</tr>
		</table>
	</form> <!-- form E -->
...
<jsp:include page="/js/input_vali.jsp" />
